...
import { ArrowLeft, User, MapPin, Shield, Trash2, UserPlus, Mail, ChevronRight, Navigation, Trophy, Globe } from 'lucide-react'
...
export default function SettingsPage({ spots = [], onDeleteSpot, onSpotNavigate }) {
  ...
  const tabs = [
    ...
    ...(isAdmin ? [{ id: 'allspots', label: 'Alle Spots', icon: Globe, count: allSpots.length }] : []),
  ]
